...
public class ProgramsResource {
	...
	public Program deleteAcourseOfProg(@PathParam("programId") String programId, Course cour){
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Program addCouseToProg(@PathParam("programId") String programId, Course cour){
		return progService.addACourseToProg(programId, cour);
	}
}
